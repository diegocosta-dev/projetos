      ...
      <Jumbotron style={{ paddingTop: '50px', paddingBottom: '100px' }}>
          ...
          <Form.Row>
            ...
            <Col sm="3">
              <Form.Control
                as="select"
                value={moedaPara}
                onChange={(event) => setMoedaPara(event.target.value)}
              >
            ...
            <Col sm="2">
              <Button variant="success" type="submit" onClick={converter}>
                ...
                <span
                  className={exibirSpiner ? 'hidden' : null}
        ...
        <Modal show={exibirModal} onHide={fechaModal}>
          <Modal.Header closeButton>
            <Modal.Title>Converção</Modal.Title>
          </Modal.Header>

          <Modal.Body>{exibirResultado}</Modal.Body>
